...
-   Copy the new fonts `WF-037420-012177-002520.woff`, `WF-037420-012177-002520.woff2`, and all `Amiri-*` from the shared Google Drive folder "Geniza – woff files only" to `sitemedia/fonts`
