...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Document',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='PGPID')),
                ('description', models.TextField(blank=True)),
                ('notes', models.TextField(blank=True)),
                ('old_input_by', models.CharField(help_text='Legacy input information from Google Sheets', max_length=255, verbose_name='Legacy input by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_shelfmarks', models.CharField(blank=True, max_length=255, verbose_name='Historical Shelfmarks')),
                ('url', models.URLField(blank=True, help_text='Link to library catalog record for this fragment.', verbose_name='URL')),
                ('iiif_url', models.URLField(blank=True, verbose_name='IIIF URL')),
                ('multifragment', models.CharField(blank=True, max_length=255)),
                ('notes', models.TextField(blank=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='corpus.collection')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('side', models.CharField(blank=True, choices=[('r', 'recto'), ('v', 'verso'), ('rv', 'recto and verso')], max_length=5)),
        ...
        migrations.AddField(
            model_name='document',
            name='doctype',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='corpus.documenttype', verbose_name='Type'),
        ),
        migrations.AddField(
            model_name='document',
            name='fragments',
