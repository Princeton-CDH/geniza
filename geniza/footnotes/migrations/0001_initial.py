    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='ISO language code', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='SourceType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('page_range', models.CharField(blank=True, help_text='The range of pages being cited. Do not include "p", "pg", etc. and follow the format # or #-#', max_length=255)),
                ('doc_relation', multiselectfield.db.fields.MultiSelectField(choices=[('E', 'Edition'), ('T', 'Translation'), ('D', 'Discussion')], help_text='How does the source relate to this document?', max_length=5, verbose_name='Document relation')),
        ...
        migrations.AddConstraint(
            model_name='creator',
            constraint=models.UniqueConstraint(fields=('first_name', 'last_name'), name='creator_unique_name'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='authorship',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='footnotes.source'),
        ),
    ]
