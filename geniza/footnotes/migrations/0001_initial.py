    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(blank=True, help_text='The primary language the source is written in', null=True, on_delete=django.db.models.deletion.SET_NULL, to='footnotes.sourcelanguage')),
