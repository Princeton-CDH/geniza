...
# (or take output dir as argument?)
...
def parse_bodleian_tei(xmlfile):
    ...
    for part in tei.parts:
        ...
        manifest.set_metadata(
            {
                "Provenance": "Static IIIF generated by CDH/PGL from Bodleian Libraries, University of Oxford",
                "License": "<a href='https://genizah.bodleian.ox.ac.uk/terms'>Terms of Use</a>",
            }
        )
        # can we borrow from their manifests?
        # https://iiif.bodleian.ox.ac.uk/iiif/manifest/01bc51ec-80fb-4318-aaf3-bc313692691f.json

        # "<span>Photo: © Bodleian Libraries, University of Oxford. Terms of use: <a href=\"https://creativecommons.org/licenses/by-nc/4.0/\">CC-BY-NC 4.0</a>. For more information, please see <a href=\"https://digital.bodleian.ox.ac.uk/terms/\">https://digital.bodleian.ox.ac.uk/terms/</a></span>"
        # and logo!
        # logo
        # @id "https://iiif.bodleian.ox.ac.uk/iiif/image/f27e28db-0b08-4f16-9bdf-3565f591fb71/full/256,/0/default.jpg"
        # @type   "dctypes:Image"
        # format  "image/jpeg"
        # service
